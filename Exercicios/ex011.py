...
# calcula sua area e a quantidade de tinta necessario para pinta-la, sabendo 
...
print('Sera necessario {:.0f} lata(s) de tinta(s) para pintar a parede de {}m².'.format(tinta, m2))